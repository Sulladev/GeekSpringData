package ru.pirozhkov.spring_data.config;
...
@Configuration
@EnableJpaRepositories("ru.pirozhkov.spring_data.repositories")
@EnableTransactionManagement
@ComponentScan("ru.pirozhkov.spring_data")
public class AppConfig {
    ...
    public DataSource getDataSource() {
        ...
        dataSource.setUrl("jdbc:h2:file:C:\\Users\\mi\\IdeaProjects\\GeekSpringData\\db\\db;MV_STORE=false");
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("ru.pirozhkov.spring_data.entity");
